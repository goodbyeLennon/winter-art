...
-dynamic arrays for the grids after determining the grid size in the file loaded at runtime.
...
class Game {
public:
			Game( std::ifstream& startGrid, int currentGrid[][XSIZE], const int YSIZE, const int XSIZE );
...
void Game::fillGrid(std::ifstream& in_s, int grid[][XSIZE], int y, int x) {
	using namespace std;
...
void Game::drawGrid(const int grid[][XSIZE], const int y, const int x) {
	using namespace std;
	int next;
...
void Game::updateGrid(int currentGrid[][XSIZE], int nextGrid[][XSIZE], const int y, const int x) {
	bool cellState;
...
bool Game::cellChecker(const int grid[][XSIZE], const int ysize, const int xsize, int yLoc, int xLoc) {
